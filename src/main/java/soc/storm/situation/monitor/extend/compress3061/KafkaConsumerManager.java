...
public class KafkaConsumerManager {
    ...
    private static Properties createConsumerConfig() {
        ...
        // properties.put("group.id", SystemConstants.TOPOLOGY_NAME + "3061A113361");
        properties.put("group.id", SystemConstants.KAFKA_CONSUMER_GROUP_ID_3061);
        ...
        properties.put("auto.offset.reset", SystemConstants.KAFKA_CONSUMER_AUTO_OFFSET_RESET_3061);
