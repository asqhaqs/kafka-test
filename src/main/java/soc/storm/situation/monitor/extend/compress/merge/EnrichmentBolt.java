...
package soc.storm.situation.monitor.extend.compress.merge;
...
public class EnrichmentBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            ...
            System.out.println("-----------------------skyeyeWebFlowLogByteArray.length:" + skyeyeWebFlowLogByteArray.length);
            ...
            for (Object skyeyeWebFlowLogByteArrayElement : pbBytesWebFlowLogList) {
                ...
                if (isWebflowLogEncrypt) {
                    System.out.println("-----------------------isWebflowLogEncrypt:" + isWebflowLogEncrypt);
                ...
                if (StringUtils.isNotBlank(skyeyeWebFlowLogStr)) {
                    ...
                    if (null != skyeyeWebFlowLog) {
                        ...
                        System.out.println("enrichmentBolt-------skyeyeWebFlowLog: " + JsonUtils.mapToJson(skyeyeWebFlowLog));
