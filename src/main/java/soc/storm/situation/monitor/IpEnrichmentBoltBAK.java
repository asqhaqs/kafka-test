 ...
 *
 */
public class IpEnrichmentBoltBAK extends BaseRichBolt {
    private static final Logger log = Logger.getLogger(IpEnrichmentBoltBAK.class);
    ...
    static {
        try {
            // 加载配置文件
            InputStream input = IpEnrichmentBoltBAK.class.getResourceAsStream("/app.properties");
            pro.load(input);
    ...
    public void sendKafkaMessage(Tuple tuple, JsonElement jsonElement, Result sReulst, Result dResult) {
        ...
        try {
            ...
            if (dipMap != null) {
                ...
                for (Map.Entry<String, String> entry3 : dipMap.entrySet()) {
            ...
            if (sipMap != null) {
                JSONObject object2Child = new JSONObject();
                for (Map.Entry<String, String> entry4 : sipMap.entrySet()) {
