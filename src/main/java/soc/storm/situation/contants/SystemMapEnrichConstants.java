...
public class SystemMapEnrichConstants extends ConfigurableContants {
    ...
    public static final String REDIS_ALERT_KEY = getProperty("alert_redis_key", "logcenter:situation-ids");
    ...
    // jinjing log separator
    public static final String FLOW_LOG_SEPARATOR = getProperty("flow_log_separator", "metadata - - -");
    public static final String ALERT_LOG_SEPARATOR = getProperty("alert_log_separator", "notice - - -");
    ...
    //jinjing alert fields name
    public static final String ALERT_FIELDS = getProperty("jinjing_alert_fields", "");
    //360 alert fields name which is not in jj alert fields
    public static final String QH_ALERT_FIELDS_NOT_IN_JJ = getProperty("qa_alert_fields","");
